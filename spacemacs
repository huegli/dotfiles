  ...
  (setq-default
   ...
   '(
     ...
     (ranger :variables
             ...
             ranger-cleanup-disable t
             ranger-ignored-extentions '("mkv" "flv" "iso" "mp4" "vg"))
     themes-megapack
     )
